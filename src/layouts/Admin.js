    ...
    <React.Fragment>
      <div className="d-flex sb-sidenav-toggled" id="wrapper">
        <div className="bg-white" id="sidebar-wrapper">
          <div className="sidebar-heading bg-success text-center text-white">
            <i className="fa fa-map-marked-alt"></i>{" "}
            <strong>GIS SMP Kab.Bandung</strong> <small>ADMIN</small>
          </div>
          <Sidebar />
        </div>
        <div id="page-content-wrapper">
          <nav className="navbar navbar-expand-lg navbar-light bg-success">
            <div className="container-fluid">
              <button
                className="btn btn-white-border btn-success "
